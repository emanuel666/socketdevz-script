# Instructivo: SocketDevz VPN Script (VPS AutoScript)
...
```
wget -qO- https://raw.githubusercontent.com/emanuel666/socketdevz-script/refs/heads/main/install.sh | bash
```

### Opcion 2

```
wget -qO xfc.sh https://raw.githubusercontent.com/emanuel666/socketdevz-script/refs/heads/main/install.sh && bash install.sh
```

### Opcion 3

```
bash <(curl -sL https://raw.githubusercontent.com/emanuel666/socketdevz-script/refs/heads/main/install.sh)
```

### Opcion 4 (recomendada)

```
wget -qO install.sh https://raw.githubusercontent.com/emanuel666/socketdevz-script/refs/heads/main/install.sh
chmod +x install.sh
./install.sh
```
